...
const postData: DataType[] = [
    {
        profession: 'Cirujano',
        name: 'Veterinario',
        imgSrc: '/images/Expert/veterinaria.png',
    },
    {
        profession: 'Cirujano',
        name: 'Veterinario',
...
export default class MultipleItems extends Component {
    ...
    render() {
        ...
        return (
            <div className="py-10 sm:py-20 bg-[#a4d8f2]">

                <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                    <div className="text-center">
                        <Fade direction={'up'} delay={400} cascade damping={1e-1} triggerOnce={true}>
                            <h2 className='text-[#39b0ec] text-lg font-normal mb-3 tracking-widest uppercase ls-51'> ESPECIALISTAS</h2>
                        </Fade>
